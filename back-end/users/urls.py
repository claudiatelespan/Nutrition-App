...
from .views import RegisterView, logout_view, get_user_info, update_user_profile, SendFriendRequestView, RespondFriendRequestView, FriendListView, PendingFriendRequestsView
