...
export default function MacroDistributionChart({ selectedDate, reloadChartsKey }) {
  ...
  if (!data)
    return (
      <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center justify-center w-full">
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center w-full">
      ...
      {chartData.length === 0 ? (
        <EmptyChartPlaceholder emoji= "🍽️🍪📊" comp = "meals and snacks" chart = "Macronutrient Distribution"/>
       ) : (
        <>
